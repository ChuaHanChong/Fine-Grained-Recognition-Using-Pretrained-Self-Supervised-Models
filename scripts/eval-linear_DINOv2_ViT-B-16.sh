...
#--output-dir /data/hanchong/open-source-weights/trained-weights/NABirds/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
...
#--config-file ./configs/ViT-B-16_DINOv2.yml \
#--pretrained-weights /data/hanchong/open-source-weights/processed-weights/vitb16_reg4_SimDINOv2_ep100.pth \
#--output-dir /data/hanchong/open-source-weights/trained-weights/Birdsnap/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
#--save-checkpoint-frequency 1 \
#--batch-size 64 \
#--epoch-length 546 \
...
#--config-file ./configs/ViT-B-16_DINOv2.yml \
#--pretrained-weights /data/hanchong/open-source-weights/processed-weights/vitb16_reg4_SimDINOv2_ep100.pth \
#--output-dir /data/hanchong/open-source-weights/trained-weights/FGVC_Aircraft/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
#--save-checkpoint-frequency 1 \
#--batch-size 32 \
#--epoch-length 104 \
...
#--config-file ./configs/ViT-B-16_DINOv2.yml \
#--pretrained-weights /data/hanchong/open-source-weights/processed-weights/vitb16_reg4_SimDINOv2_ep100.pth \
#--output-dir /data/hanchong/open-source-weights/trained-weights/Stanford_Cars/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
#--save-checkpoint-frequency 1 \
#--batch-size 32 \
#--epoch-length 223 \
...
#--config-file ./configs/ViT-B-16_DINOv2.yml \
#--pretrained-weights /data/hanchong/open-source-weights/processed-weights/vitb16_reg4_SimDINOv2_ep100.pth \
#--output-dir /data/hanchong/open-source-weights/trained-weights/Stanford_Dogs/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
#--save-checkpoint-frequency 1 \
#--batch-size 32 \
#--epoch-length 356 \
...
#--config-file ./configs/ViT-B-16_DINOv2.yml \
#--pretrained-weights /data/hanchong/open-source-weights/processed-weights/vitb16_reg4_SimDINOv2_ep100.pth \
#--output-dir /data/hanchong/open-source-weights/trained-weights/CUB200-2011/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
#--save-checkpoint-frequency 1 \
#--batch-size 32 \
#--epoch-length 156 \
...
#--config-file ./configs/ViT-B-16_DINOv2.yml \
#--pretrained-weights /data/hanchong/open-source-weights/processed-weights/vitb16_reg4_SimDINOv2_ep100.pth \
#--output-dir /data/hanchong/open-source-weights/trained-weights/Oxford_Flowers/linear-probing/ViT-B-16_DINOv2 \
#--epochs 50 \
#--save-checkpoint-frequency 1 \
#--batch-size 16 \
#--epoch-length 63 \
